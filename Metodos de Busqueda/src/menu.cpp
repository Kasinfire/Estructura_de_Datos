...
void Menu::handleSearchCreateria(int& opc) {
    int metOpc;
    do{
        system("cls");
...
void Menu::performSearch(int&opc, int& metOpc) {
    string searchTxt;
    ...
    if (pos != -1){
        cout<<"\nCancion encontrada en posicion " << pos + 1 << "!!" <<endl;
        ...
        cout << left 
            ...
            cout << foundSong.toString() <<endl;
        }catch (const List<Song,600>::Exception&e){
...
Menu::Menu(List<Song,6000>& l) : songsList(&l){
    runMenu();
}
